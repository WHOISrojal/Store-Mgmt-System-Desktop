...
export default function Invoice() {
  ...
  if (!sale || !settings)
    return (
      <div
        style={{ textAlign: "center", padding: "60px 0", color: "var(--t3)" }}
      >
        <i
  ...
  const statusLabel =
    sale.paymentType === "CHEQUE"
      ...
      : sale.paymentType === "CREDIT"
        ...
        : "PAID";
  const statusColor =
    statusLabel === "PAID" || statusLabel === "CLEARED"
  ...
  const balanceDue = Math.max(
    0,
    Math.round((sale.totalAmount - amountPaid) * 100) / 100,
  );
      ...
      >
        ...
        >
          ...
          <div>
            ...
            {[
              ...
              {
                label: "Date",
                value: new Date(sale.createdAt).toLocaleDateString("en-GB", {
                  day: "numeric",
                  month: "long",
                  year: "numeric",
                }),
              ...
              {
                label: "Time",
                value: new Date(sale.createdAt).toLocaleTimeString("en-US", {
                  hour: "2-digit",
                  minute: "2-digit",
                }),
              },
          ...
          {sale.paymentType === "CHEQUE" && (
            <div>
              ...
              {[
                ...
                {
                  label: "Date",
                  value: new Date(sale.chequeDate).toLocaleDateString("en-GB"),
                },
              ...
              {sale.items.map((item, i) => (
                <tr key={i} style={{ borderBottom: "1px solid #f1f5f9" }}>
                  ...
                  <td style={{ padding: "12px 12px" }}>
                    ...
                    {(item.product?.lotNo || item.product?.code) && (
                      <div
                        style={{
                          fontSize: 10.5,
                          color: "#94a3b8",
                      ...
                      >
                        {item.product?.lotNo && `Lot: ${item.product.lotNo}`}
                        {item.product?.lotNo && item.product?.code && "  ·  "}
                  ...
                  >
                    <button
                      onClick={() =>
                        openReturnModal(item.product?._id, item.product?.name)
                      }
                      style={{
                        padding: "4px 10px",
                        fontSize: 11.5,
            ...
            <div style={{ minWidth: 260 }}>
              ...
              >
                ...
                <span
                  style={{
                    fontWeight: 600,
                    color: hasDiscount ? "#059669" : "#94a3b8",
                  }}
                >
                  {hasDiscount
                      ...
                      {advMethod && (
                        <span
                          style={{
                            ...
                            fontWeight: 700,
                            color:
                              advMethod === "ONLINE" ? "#1e3a8a" : "#065f46",
                            background:
                              advMethod === "ONLINE" ? "#eff6ff" : "#ecfdf5",
        ...
        {returns.length > 0 && (
          <div style={{ padding: "0 40px 24px" }}>
            ...
            >
              ...
              >
                <i className="ti ti-arrow-back-up" style={{ marginRight: 5 }} />
                Return history
              </div>
              <table
                style={{
                  ...
                  {returns.map((r) => (
                    ...
                    >
                      ...
                      <td style={{ padding: "8px 10px" }}>
                        ...
                        {(r.product?.lotNo || r.product?.code) && (
                          <div
                            style={{
                              fontSize: 10.5,
                              color: "#94a3b8",
                          ...
                          >
                            {r.product?.lotNo && `Lot: ${r.product.lotNo}`}
                            {r.product?.lotNo && r.product?.code && "  ·  "}
        ...
        >
          <div style={{ fontSize: 12, color: "#94a3b8" }}>
            Generated by <strong style={{ color: "#475569" }}>Karobar</strong> ·{" "}
            ...
            <div style={{ padding: "18px 20px" }}>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                >
                  ...
                  <option value="Damaged in delivery">
                    Damaged in delivery
                  </option>
              ...
              >
                ...
                />
                Returning items will restore stock. This action cannot be
                undone.
              </div>
